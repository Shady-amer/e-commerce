...
const Nav = () => {
  ...
  return (
    <div>
       <section className="h-auto md:h-96 bg-[url('/hero-bg.jpg')] bg-cover bg-center">
                   ...
                   <h1 className=' text-white text-6xl sm:text-3xl md:text-5xl font-bold leading-snug mt-32 ml-[40rem]'>GALLERY</h1>
                   </section>
    </div>
  )
}
